"""
OcchioEsperto.it — Authentication utilities.
JWT token management, password hashing, and user dependencies.
"""
import datetime
...
async def get_optional_user(
    ...
    """Dependency: get user if token provided, but don't fail if not."""

      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-8 pt-8 border-t border-vespa-black-light/50">
          <p className="text-xs text-vespa-gray leading-relaxed text-center">
            OcchioEsperto.it fornisce analisi orientative e probabilistiche: non costituisce certificato di origine,
            perizia o garanzia di autenticità. Non è affiliato, sponsorizzato o approvato dal Gruppo Piaggio;

            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-vespa-gray leading-relaxed">
                  Questo servizio offre un'analisi probabilistica e orientativa basata su dati storici, foto e dati inseriti dall'utente.
                  Non costituisce certificato di origine, perizia, valutazione assicurativa o garanzia di autenticità.
                  OcchioEsperto non è affiliato, sponsorizzato o approvato dal Gruppo Piaggio; i marchi Vespa e Piaggio
